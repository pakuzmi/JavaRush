    ...
    public void processVideos()
    {
        ...
        Collections.sort(bigList.get(0), new Comparator<Advertisement>()
        {
            ...
            public int compare(Advertisement o1, Advertisement o2)
            {
                ...
                if(Long.compare(o1.getAmountPerOneSecondDisplaying(),o2.getAmountPerOneSecondDisplaying()) == 1)
                    return (1);
                if(Long.compare(o1.getAmountPerOneSecondDisplaying(),o2.getAmountPerOneSecondDisplaying()) == -1)
                    return (-1);
        ...
        for (Advertisement a : advertisement)
        {
            ...
            ConsoleHelper.writeMessage(a.getName() + " is displaying... " + a.getAmountPerOneDisplaying() + ", " + a.getAmountPerOneSecondDisplaying());
            a.revalidate();
        }
    }
}
